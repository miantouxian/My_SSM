...
${msg}
    ...
    <ul class="list-group" style="width: 100%">
        <div class="panel-heading" style="background-color: white">
            <a href="${pageContext.request.contextPath }/main">班级工具箱</a> › 所有任务
        </div>
            ...
            <li class="list-group-item">
                <div style="height: 50px">
                    ...
                    <div style="width: 89%;float: left">
                        ...
                        <div>
                            <a href="${pageContext.request.contextPath }/user?userid=${task.user.userid}"><span class="label label-default" >${task.offeror}</span></a>
